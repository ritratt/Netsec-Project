...
_ADD_CHAIN_PATH = "ct/v1/get-proof-by-hash"
...
class LogClient(object):
    ...
    def get_proof_by_hash(self, leaf_hash, tree_size):
        ...
        try:
            ...
            raise InvalidResponseError("%s returned invalid data: expected a base64-encoded " "audit proof, got %s" "\n%s" % (self.servername, response, e))
				
        return proof_response

    def add_chain(self, cert_chain):

	response self._req_body(_ADD_CHAIN_PATH, params={"chain":cert_chain})
